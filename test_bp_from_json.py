...
if __name__ == "__main__":
    ...
    bp_txt = (
        "0eNqd2tFumzAYxfF34TpUNcb2IU8yaaommritNUIiIO2qKu8+SLYma1HXfy/j"
    ...
    bp_book_txt = (
        "0eNrtlNtugzAMht8l10k1oBxfZZqqABZEhQQlabuq4t2XgNayNttou5t"
    ...
    bp4_txt = (
        "0eNqdk9tugzAMht/F16RaoRxfZZqmABZYCwElabuq4t3n"
    ...
    for i in range(len(bps)):
        ...
        # print('bp.data = ', type(bp.data), bp.data)
        # print()
        # print('bp.obj = ', type(bp.obj), bp.obj)
        print(bp)
        print(bp.get_filename())
        print(bp.get_md5())
        if bp.is_blueprint():
            print("blueprint")
        elif bp.is_blueprint_book():
            print("is_blueprint_book")
        print(path)
